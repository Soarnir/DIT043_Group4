...
public class ReviewMenu {
    ...
    private static final int PRINT_ALL_ITEM_REVIEW = 3;
    private static final int PRINT_MEAN_GRADE_ITEM = 4;
    private static final int PRINT_ALL_ITEM_COMMENTS = 5;
    private static final int PRINT_ALL_ITEM_REVIEWS = 6;
    private static final int PRINT_MOST_REVIEWS_ITEM = 7;
    private static final int PRINT_LEAST_REVIEWS_ITEM = 8;
